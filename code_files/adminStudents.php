...
<body>
    ...
    <script>
     ...
     <center><button style="width:10rem; height:3rem; border-radius:0.2rem; margin-right:2rem; border-width: 0.25rem; background-color: rgb(19, 185, 19); border-style: none"><a href="addstudent.php" class="mahi">Add Students</a></button></center>
</body>

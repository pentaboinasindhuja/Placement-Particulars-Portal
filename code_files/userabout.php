...
<body>
  ...
  <ol class="para">
    <li>To produce Computer Science graduates with sound subject knowledge, certified skill-sets and to foster leading
      edge in the fast changing field who can address current professional challenges</li5h>
...
<footer id="Contact" class="footer">
  ...
  <i class="fas fa-envelope"></i> &nbsp <a href="mailto: kethavathsrinivas2004@gmail.com"
    style="color: white;">kethavathsrinivas2004@gmail.com</a>
